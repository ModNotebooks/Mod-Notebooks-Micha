class Api::V1::NotebooksController < Api::BaseController
  ...
  private
    ...
    def find_notebook_by_notebook_identifier
      notebook_identifier = create_params.fetch(:notebook_identifier).downcase
      @notebook = Notebook.unreserved.find_by!("lower(notebook_identifier) = ?", notebook_identifier)
    end
